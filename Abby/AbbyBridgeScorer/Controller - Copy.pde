class Controller
{
  ...
  Controller(x, y)
  {
    ...
    info = new Information(x+160, y, 185, 125);
  ...
  void Calculate()
  {
    ...
    else
    {
      ...
      { 
        ...
        var over7 = m.value - 7;
        if (s.value == "NT" && (d.value == "X" || d.value == "XX")) over7 = c.value - 1;
        
        var A1 = 0;
        var A2 = 0;
        var Amid = 0;
        if (s.value == "NT")                  { A1 = 40; A2 = 30 * over7; Amid = 2; m1 = "40 (for trick 7)";  m2 = "30 (for trick 8-13)"; m3 = "NT"; }
        if (s.value == "H" || s.value == "S") { A1 = 30; A2 = 30 * over7; Amid = 3; m1 = "30 (for trick 7)";  m2 = "30 (for trick 8-13)"; m3 = "Majors"; }
        if (s.value == "C" || s.value == "D") { A1 = 20; A2 = 20 * over7; Amid = 4; m1 = "20 (for trick 7)";  m2 = "20 (for trick 8-13)"; m3 = "minors"; }
        ...
        if (d.value == null)  
        {
          ...
          if (A2 > 0) 
          {
            ...
            //var tricks = over7 > 1 ? "tricks" : "trick";
            info.message.push("   x " + over7 + " (over 7 tricks)");// + tricks + ")");
        ...
        if (d.value == "X" || d.value == "XX")  
        {
          ...
          //if (c.value >= Amid && c.value < 6) A3 = A3 + 200;
          
          var instult = 50*dblMult;
          var adjustForNT = 0;
          var m5 = "";
          //if (s.value == "NT") {adjustForNT = (20 * dblMult) * (c.value -1) ; m5 = "" + adjustForNT + " (NT " + dblType + " adjust: " + "-" + (20*dblMult) + " x " + (c.value -1) + " contracts)"; }
          
          //A1 = (A1 * c.value) * (2 * dblMult);
          ...
          score.value = A1 + A2 + A3 + instult - adjustForNT;
          
          
          // message
          info.message.push("     [for " + m3 + "]");
          info.message.push("   " + m1);
          info.message.push("   x " + c.value + " (contract for double)");
